...
class UnitSelectionScreen extends StatelessWidget {
  final List<String> categories = const ['Масса', 'Валюта', 'Температура', 'Длина', 'Микки (Чувствительность мыши)'];
...
class _ConversionScreenState extends State<ConversionScreen> {
  ...
  Map<String, Map<String, double>> conversionRates = {
    ...
    'Валюта': {'USD': 1, 'EUR': 0.96, 'RUB': 98.0},
    'Температура': {'Цельсий': 1, 'Фаренгейт': 33.8, 'Кельвин': 274.15},
    'Длина': {'Сантиметр': 1, 'Метр': 0.01, 'Километр': 1e-5},
    'Микки (Чувствительность мыши)': {'Точки на дюйм': 500, 'Точки на миллиметр': 16000},
  };
